        ...
        <div className="relative rounded-lg">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="relative w-full h-[400px] lg:h-[500px]">
              ...
              <div className="absolute top-[25%] left-[5%] z-20">
                <div className="relative">
                  <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-full border-4 border-white shadow-2xl overflow-hidden relative z-20">
              ...
              <div className="absolute top-[40%] left-[48%] -translate-x-1/2 z-20">
                <div className="w-28 h-28 lg:w-36 lg:h-36 rounded-full border-4 border-white shadow-2xl overflow-hidden relative grayscale opacity-90">
              ...
              <div className="absolute top-[15%] right-[5%] z-20">
                <div className="relative">
                  ...
                  {/* Chat Bubble */}
                  <div className="absolute top-8 -left-52 lg:-left-64 bg-[#526595] px-4 py-3 lg:px-5 lg:py-4 rounded-xl rounded-tr-none shadow-lg w-52 lg:w-60 z-30">
                    <p className="text-white text-sm lg:text-[15px] leading-snug">Can you please check the order status for me?</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute top-[75%] left-[25%] z-20">
                <div className="relative">
                  ...
                  {/* Bubble: Find a watch */}
                  <div className="absolute -top-20 -left-10 lg:-left-20 bg-[#526595] px-4 py-3 lg:px-5 lg:py-4 rounded-xl rounded-br-none shadow-lg w-48 lg:w-56 z-30">
