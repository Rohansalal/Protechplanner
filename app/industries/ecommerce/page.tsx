                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8 animate-in slide-in-from-left duration-700">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                                Scale your online store with <span className="text-[#6BA3FF]">dedicated support</span>
                            </h1>
                        ...
                        <ScrollAnimation className="relative">
                            <div className="bg-[#213959] rounded-3xl p-8 text-center text-white relative overflow-hidden">
                                ...
                                <div className="relative z-10 py-12">
                                    ...
                                    <p className="text-blue-100 mb-8 text-lg">Don't let operations bottle-neck your sales.</p>
