                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8 animate-in slide-in-from-left duration-700">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                                Empower your small business with our <span className="text-indigo-300">expert support</span>
                            </h1>
                        ...
                        <div className="relative lg:h-[600px] animate-in slide-in-from-right duration-700 delay-200 hidden lg:block">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/20 to-transparent rounded-3xl border border-white/10 backdrop-blur-sm p-8">
                                    ...
                                    <div className="space-y-6 relative z-10">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="h-32 bg-indigo-500/20 rounded-xl border border-indigo-500/30 p-4 flex flex-col justify-end">
                                                ...
                                                <div className="text-xs text-indigo-200">Support Available</div>
                                            </div>
                        ...
                        {services.map((service, index) => (
                            <ScrollAnimation key={index} delay={index * 0.1}>
                                <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 group h-full">
                                    <div className="w-14 h-14 rounded-xl bg-indigo-50 flex items-center justify-center mb-6 group-hover:bg-[#213959] transition-colors duration-300">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                                ...
                                {[
                                    ...
                                    <ScrollAnimation key={idx} delay={idx * 0.2}>
                                        <div className="flex gap-6">
                                            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center text-[#213959] font-bold text-xl">
                                                {item.step}
                                            </div>
                                            <div>
                        ...
                        <ScrollAnimation className="relative">
                            <div className="bg-[#213959] rounded-3xl p-8 text-center text-white relative overflow-hidden">
                                ...
                                <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-64 h-64 bg-emerald-500 rounded-full opacity-20 blur-3xl"></div>

                                <div className="relative z-10 py-12">
                                    <h3 className="text-3xl font-bold mb-6">Ready to talk?</h3>
                                    <p className="text-indigo-200 mb-8 text-lg">Take the Next Step towards Success: Reach Out to Us Today!</p>
                    ...
                    <Accordion type="single" collapsible className="space-y-4">
                        {faqs.map((faq, index) => (
                            <AccordionItem key={index} value={`item-${index}`} className="bg-white border border-slate-200 rounded-lg px-6 data-[state=open]:shadow-md transition-all duration-200">
                                <AccordionTrigger className="text-lg font-semibold text-[#213959] hover:text-indigo-600 text-left">
                                    {faq.question}
                                </AccordionTrigger>
