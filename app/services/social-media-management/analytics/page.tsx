...
const SERVICES = [
  {
    ...
    description: "Comprehensive tracking of all key metrics including reach, impressions, engagement, and conversions across platforms."
  },
  {
    icon: TrendingUp,
    title: "Growth Metrics",
    description: "Monitor follower growth, audience demographics, and engagement trends to understand your social media trajectory."
  },
  {
    icon: PieChart,
    title: "Engagement Analysis",
    description: "Deep dive into what content resonates with your audience through detailed engagement rate analysis."
  },
  {
    icon: LineChart,
    title: "Monthly Reports",
    description: "Detailed monthly reports with actionable insights and recommendations for continuous improvement."
  }
];

const BENEFITS = [
  "Data-driven decisions backed by real metrics",
  "Identify top-performing content and strategies",
  "Track ROI and business impact accurately",
...
const USE_CASES = [
  {
    ...
    description: "Measure the success of marketing campaigns with detailed performance metrics.",
    metrics: "Real-time data"
  },
  {
    title: "Content Optimization",
    description: "Identify which content types and topics drive the most engagement.",
    metrics: "Weekly insights"
  },
  {
    title: "Audience Insights",
    description: "Understand your audience demographics, interests, and online behavior patterns.",
    metrics: "Deep analytics"
  },
  {
    title: "ROI Tracking",
    description: "Connect social media efforts to business outcomes and revenue generation.",
    metrics: "Custom KPIs"
  }
];
      ...
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-white via-purple-50/20 to-white pt-5 pb-20 md:pt-7 md:pb-28 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <span>/</span>
            <span className="text-[#215ACD] font-medium">Analytics & Reporting</span>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                <span className="text-black">Data-Driven </span>
                <span className="text-[#215ACD]">Insights</span>
                <br />
              ...
              >
                Comprehensive social media analytics and reporting to track performance, understand your audience, and drive continuous growth.
              </motion.p>
            ...
            >
              ...
              <Image
                src="https://placehold.co/600x500/f3e8ff/215acd?text=Analytics+Reporting"
                alt="Analytics & Reporting Services"
                fill
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-[32px] md:text-[40px] font-bold font-['Inter'] mb-4">
              <span className="text-[#414141]">Complete Analytics </span>
              <span className="text-[#215ACD]">Solutions</span>
            </h2>
            <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto">
              From performance tracking to detailed reporting, we provide the insights you need to succeed.
            </p>
          </div>
      ...
      <section className="py-20 bg-[#F8F9FB]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto">
              See how businesses leverage our analytics expertise to make smarter decisions.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-[32px] md:text-[40px] font-bold font-['Inter'] mb-6">
                ...
                <span className="text-[#215ACD]">Analytics Services?</span>
              </h2>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-[#215ACD] to-[#1a49a8] rounded-2xl p-8 text-white">
                ...
                <h3 className="text-[24px] font-bold mb-3">Actionable Insights</h3>
                <p className="text-white/90 mb-4">
                  We don't just provide data - we deliver actionable insights and recommendations that drive real business growth.
                </p>
              ...
              <div className="bg-[#F8F9FB] rounded-2xl p-8">
                ...
                <h3 className="text-[24px] font-bold text-[#414141] mb-3">Real-Time Tracking</h3>
                <p className="text-[#5C5C5C]">
                  Monitor your social media performance in real-time with 24/7 data updates and instant alerts for important metrics.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-[#215ACD] to-[#1a49a8] rounded-[24px] overflow-hidden p-12 md:p-16">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
              ...
              <p className="text-white/90 text-[18px] md:text-[20px] mb-8">
                Get comprehensive analytics and insights that help you make smarter social media decisions.
              </p>
