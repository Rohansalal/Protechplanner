...
export default function ReminderServicesLoading() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="text-center border-2 rounded-lg p-8">
                <div className="w-16 h-16 bg-accent animate-pulse rounded-full mx-auto mb-6" />
                <div className="h-6 w-32 mx-auto bg-accent animate-pulse rounded-md mb-4" />
                <div className="h-4 w-full bg-accent animate-pulse rounded-md" />
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-secondary/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="border-2 rounded-lg p-8 text-center">
                <div className="h-8 w-32 mx-auto bg-accent animate-pulse rounded-md mb-4" />
                <div className="h-12 w-24 mx-auto bg-accent animate-pulse rounded-md mb-4" />
                <div className="h-6 w-48 mx-auto bg-accent animate-pulse rounded-md mb-6" />
                <div className="space-y-3 mb-6">
                  {Array.from({ length: 5 }).map((_, j) => (
                    <div key={j} className="flex items-center space-x-3">
                      <div className="w-5 h-5 bg-accent animate-pulse rounded-md" />
