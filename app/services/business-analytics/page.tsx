...
const SERVICES = [
  {
    ...
    description: "Comprehensive data collection and analysis services to uncover valuable business insights from multiple sources.",
    link: "/services/business-analytics/data-collection-analysis"
  },
  {
    icon: FileSpreadsheet,
    title: "Custom Report Creation",
    description: "Professional custom reports tailored to your specific business needs with actionable recommendations.",
    link: "/services/business-analytics/custom-report-creation"
  },
  {
    icon: Search,
    title: "Market Research",
    description: "In-depth market research and competitor analysis to inform strategic business decisions.",
    link: "/services/business-analytics/market-research"
  },
  {
    icon: Target,
    title: "KPI Monitoring",
    description: "Performance tracking and KPI monitoring to measure progress toward your business goals.",
    link: "/services/business-analytics/kpi-monitoring"
  },
  {
    icon: Monitor,
    title: "Dashboard Creation",
    description: "Interactive dashboard creation and maintenance for real-time business intelligence and monitoring.",
    link: "/services/business-analytics/dashboard-creation"
  },
  {
    icon: TrendingUp,
    title: "Forecasting & Trends",
    description: "Advanced trend analysis and forecasting to help you plan strategically for the future.",
...
const BENEFITS = [
  ...
  "Identify growth opportunities and risks early",
  "Reduce costs through operational insights",
  "Improve forecasting accuracy by 80%",
  "Real-time visibility into business performance",
  "Custom analytics tailored to your industry"
];
...
const USE_CASES = [
  {
    ...
    metrics: "30% revenue boost"
  },
  {
    title: "Customer Insights",
    description: "Understand customer behavior, preferences, and lifetime value.",
    metrics: "2x retention rate"
  },
  {
    title: "Operational Efficiency",
    description: "Identify bottlenecks and optimize processes for maximum efficiency.",
...
const STATS = [
  ...
  { value: "80%", label: "Better Forecasting" }
];
      ...
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-white via-blue-50/20 to-white pt-5 pb-20 md:pt-7 md:pb-28 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <span>/</span>
            <span className="text-[#215ACD] font-medium">Business Analytics</span>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                ...
                <br />
                <span className="text-black">Smart Decisions</span>
              </motion.h1>
              ...
              >
                Comprehensive business analytics and reporting services to help you make informed decisions, identify opportunities, and drive sustainable growth.
              </motion.p>
            ...
            >
              ...
              <Image
                src="https://placehold.co/600x500/dbeafe/215acd?text=Business+Analytics"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto">
              From data collection to advanced forecasting, we provide comprehensive analytics services to unlock business insights.
            </p>
          </div>
      ...
      <section className="py-20 bg-[#F8F9FB]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto">
              See how businesses leverage our analytics expertise to drive growth and efficiency.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-[#215ACD] to-[#1a49a8] rounded-2xl p-8 text-white">
                ...
                <p className="text-white/90 mb-4">
                  Your business data is protected with enterprise-grade security measures and strict confidentiality protocols.
                </p>
              ...
              <div className="bg-[#F8F9FB] rounded-2xl p-8">
                ...
                <p className="text-[#5C5C5C]">
                  We don't just provide data - we deliver actionable insights and strategic recommendations that drive real business results.
                </p>
              </div>
            </div>
          </div>
