...
const SERVICES = [
  {
    ...
    description: "Accurate data entry from various sources including PDFs, scanned documents, handwritten forms, and legacy systems into your preferred format."
  },
  {
    icon: Database,
    title: "Database Management",
    description: "Organize, clean, and maintain your databases with regular updates, deduplication, and data validation to ensure accuracy."
  },
  {
    icon: BarChart3,
    title: "Data Analysis & Reporting",
    description: "Transform raw data into actionable insights with custom reports, dashboards, and data visualization."
  },
  {
    icon: RefreshCw,
    title: "Data Migration & Integration",
    description: "Seamlessly migrate data between systems and integrate multiple data sources for unified business intelligence."
  }
];

const BENEFITS = [
  "99.9% accuracy rate with double-entry verification",
  "Save 15-20 hours per week on manual data tasks",
...
const USE_CASES = [
  {
    ...
    description: "Keep your customer database clean, updated, and enriched with valuable insights.",
    metrics: "500+ contacts/week"
  },
  {
    title: "Financial Records",
    description: "Accurate entry and reconciliation of invoices, expenses, and financial transactions.",
    metrics: "1000+ entries/month"
  },
  {
    title: "Inventory Tracking",
    description: "Real-time inventory updates across multiple locations and sales channels.",
    metrics: "24/7 monitoring"
  },
  {
    title: "Research Data",
    description: "Compile and organize research findings, survey responses, and market data.",
...
export default function DataEntryPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      {/* <section className="relative w-full overflow-hidden bg-gradient-to-br from-white via-green-50/20 to-white pt-32 pb-20 md:pt-40 md:pb-32 px-2"> */}
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-white via-green-50/20 to-white pt-5 pb-20 md:pt-7 md:pb-28 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <span>/</span>
            <span className="text-[#215ACD] font-medium">Data Entry & Management</span>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                <span className="text-black">Accurate </span>
                <span className="text-[#215ACD]">Data</span>
                <br />
                <span className="text-black">Powerful Insights</span>
              </motion.h1>
              ...
              >
                Transform your raw data into organized, actionable information. Our expert team handles data entry, management, and analysis with 99.9% accuracy.
              </motion.p>
            ...
            >
              ...
              <Image
                src="https://placehold.co/600x500/f0fdf4/215acd?text=Data+Management"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-[32px] md:text-[40px] font-bold font-['Inter'] mb-4">
              ...
              <span className="text-[#215ACD]">Data Solutions</span>
            </h2>
            <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto">
              From simple data entry to complex database management, we provide end-to-end data services.
            </p>
          </div>
      ...
      <section className="py-20 bg-[#F8F9FB]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto">
              See how businesses like yours leverage our data services.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-[32px] md:text-[40px] font-bold font-['Inter'] mb-6">
                ...
                <span className="text-[#215ACD]">Data Services?</span>
              </h2>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-[#215ACD] to-[#1a49a8] rounded-2xl p-8 text-white">
                ...
                <h3 className="text-[24px] font-bold mb-3">Data Security</h3>
              ...
              <div className="bg-[#F8F9FB] rounded-2xl p-8">
                ...
                <p className="text-[#5C5C5C]">
                  Get your data processed quickly without sacrificing accuracy. Our team works efficiently to meet your deadlines.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-[#215ACD] to-[#1a49a8] rounded-[24px] overflow-hidden p-12 md:p-16">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
              ...
              <p className="text-white/90 text-[18px] md:text-[20px] mb-8">
                Stop wasting time on manual data entry. Let our experts handle it with precision and speed.
              </p>
