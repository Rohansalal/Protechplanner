...
const SERVICES = [
  {
    ...
    description: "Comprehensive administrative assistance including document management, data entry, and office coordination.",
    link: "/services/hire-virtual-assistance/administrative-support"
  },
  {
    icon: Calendar,
    title: "Calendar & Scheduling",
    description: "Professional calendar management, appointment scheduling, and meeting coordination services.",
    link: "/services/hire-virtual-assistance/calendar-scheduling"
  },
  {
    icon: Mail,
    title: "Email Management",
    description: "Efficient email handling, inbox organization, response drafting, and follow-up management.",
    link: "/services/hire-virtual-assistance/email-management"
  },
  {
    icon: FileText,
    title: "Document Preparation",
    description: "Professional document creation, formatting, proofreading, and presentation design services.",
    link: "/services/hire-virtual-assistance/document-preparation"
  },
  {
    icon: Phone,
    title: "Customer Communication",
    description: "Handle customer inquiries, support tickets, live chat, and maintain excellent client relationships.",
    link: "/services/hire-virtual-assistance/customer-communication"
  },
  {
    icon: Database,
    title: "Data Management",
    description: "Organize, update, and maintain databases, CRM systems, and spreadsheets with accuracy.",
    link: "/services/hire-virtual-assistance/data-management"
  }
];

const BENEFITS = [
  "Save up to 70% compared to hiring in-house",
  "Pre-vetted assistants with 5+ years experience",
  "Flexible hours - part-time or full-time",
  "Start within 48 hours of approval",
  "No overhead costs or employee benefits",
...
const USE_CASES = [
  {
    ...
    description: "Free up your time by delegating administrative tasks to skilled virtual assistants.",
    metrics: "20+ hrs saved/week"
  },
  {
    title: "Small Businesses",
    description: "Get professional support without the cost of full-time employees.",
    metrics: "70% cost savings"
  },
  {
    title: "Entrepreneurs",
    description: "Focus on growth while your VA handles day-to-day operations.",
    metrics: "2x productivity"
  },
  {
    title: "Remote Teams",
    description: "Scale your team quickly with reliable virtual assistance.",
    metrics: "Flexible scaling"
  }
];

const STATS = [
  { value: "500+", label: "VAs Available" },
      ...
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-white via-blue-50/20 to-white pt-5 pb-20 md:pt-7 md:pb-28 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <span>/</span>
            <span className="text-[#215ACD] font-medium">Hire Virtual Assistance</span>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                <span className="text-black">Expert Virtual </span>
                <span className="text-[#215ACD]">Assistants</span>
                <br />
                <span className="text-black">On Demand</span>
              </motion.h1>
              ...
              >
                Hire skilled virtual assistants to handle administrative tasks, manage your calendar, and boost your productivity - all at 70% lower cost than in-house staff.
              </motion.p>
              ...
              >
                ...
                >
                  <Link href="/contact">Hire Your VA Now</Link>
                </Button>
                <Button
                  asChild
                  variant="outline"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-[32px] md:text-[40px] font-bold font-['Inter'] mb-4">
              <span className="text-[#414141]">Complete Virtual Assistant </span>
              <span className="text-[#215ACD]">Services</span>
            </h2>
            <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto">
              From administrative support to data management, our VAs handle everything you need.
            </p>
          </div>
      ...
      <section className="py-20 bg-[#F8F9FB]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto">
              See how professionals leverage virtual assistants to boost productivity and save time.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-[32px] md:text-[40px] font-bold font-['Inter'] mb-6">
                ...
                <span className="text-[#215ACD]">Virtual Assistants?</span>
              </h2>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-[#215ACD] to-[#1a49a8] rounded-2xl p-8 text-white">
                ...
                <h3 className="text-[24px] font-bold mb-3">Vetted Professionals</h3>
                <p className="text-white/90 mb-4">
                  Every virtual assistant goes through rigorous screening and background checks before joining our network.
                </p>
              ...
              <div className="bg-[#F8F9FB] rounded-2xl p-8">
                ...
                <h3 className="text-[24px] font-bold text-[#414141] mb-3">Quick Start</h3>
                <p className="text-[#5C5C5C]">
                  Get matched with the perfect VA and start working together within 48 hours. No lengthy hiring process.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-[#215ACD] to-[#1a49a8] rounded-[24px] overflow-hidden p-12 md:p-16">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
              ...
              <p className="text-white/90 text-[18px] md:text-[20px] mb-8">
                Hire a skilled virtual assistant today and reclaim 20+ hours per week to focus on what matters most.
              </p>
