...
const SERVICES = [
  {
    ...
    description: "Professional document creation, formatting, editing, and organization for all your business needs."
  },
  {
    icon: Database,
    title: "Data Entry & Processing",
    description: "Accurate data entry, database management, and spreadsheet organization with 99.9% accuracy."
  },
  {
    icon: Folder,
    title: "File Organization",
    description: "Systematic digital file organization, cloud storage management, and document indexing."
  },
  {
    icon: ClipboardList,
    title: "Report Preparation",
    description: "Comprehensive business reports, presentations, and executive summaries tailored to your needs."
  }
];

const BENEFITS = [
  "Save 15+ hours weekly on administrative tasks",
  "99.8% accuracy rate in all deliverables",
  "Scalable support as your business grows",
  "Systematic organization for improved efficiency",
...
const USE_CASES = [
  {
    ...
    description: "Comprehensive administrative support for rapidly growing startups.",
    metrics: "25hrs saved/week"
  },
  {
    title: "Legal Firms",
    description: "Document organization and client file management for law offices.",
    metrics: "80% faster retrieval"
  },
  {
    title: "E-commerce",
    description: "Order processing, inventory management, and customer data entry.",
    metrics: "500+ orders/week"
  },
  {
    title: "Consulting",
    description: "Report preparation, presentation creation, and client documentation.",
      ...
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-white via-blue-50/20 to-white pt-5 pb-20 md:pt-7 md:pb-28 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <span>/</span>
            <Link href="/services/hire-virtual-assistance" className="hover:text-[#215ACD] transition-colors">Hire Virtual Assistance</Link>
            <span>/</span>
            <span className="text-[#215ACD] font-medium">Administrative Support</span>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                ...
                <span className="text-[#215ACD]">Administrative</span>
                <br />
              ...
              >
                Comprehensive administrative support to streamline your business operations. Our virtual assistants handle document management, data entry, file organization, and reporting.
              </motion.p>
              ...
              >
                ...
                >
                  <Link href="/services/hire-virtual-assistance">
            ...
            >
              ...
              <Image
                src="https://placehold.co/600x500/dbeafe/215acd?text=Admin+Support"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-[32px] md:text-[40px] font-bold font-['Inter'] mb-4">
              <span className="text-[#414141]">Administrative </span>
      ...
      <section className="py-20 bg-[#F8F9FB]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto">
              See how businesses leverage administrative support to improve efficiency.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-[#215ACD] to-[#1a49a8] rounded-2xl p-8 text-white">
                ...
                <h3 className="text-[24px] font-bold mb-3">Secure & Confidential</h3>
                <p className="text-white/90 mb-4">
                  Your business documents and data are handled with strict confidentiality and enterprise-grade security.
                </p>
              ...
              <div className="bg-[#F8F9FB] rounded-2xl p-8">
                ...
                <p className="text-[#5C5C5C]">
                  Get your administrative tasks completed quickly with our efficient processes and dedicated support.
                </p>
              </div>
            </div>
          </div>
